...
//Thank you Mike Karlesky (@mkarlesky on github) for all your help creating this code! You are the best!
                       ...
                       if(brain.readSignalQuality() == 0) {
                          ...
                          //First, we have to detect when time is greater than 60,000
                           ...
                           //Add every content value together
                            ...
                            dayDreamMean = dayDreamMean + highBetaValue;2
