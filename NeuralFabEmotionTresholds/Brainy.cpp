...
Brainy::Brainy(Stream &_brainStream) {
...
void Brainy::clearPacket() {
//    for (uint8_t i = 0; i < MAX_PACKET_LENGTH; i++) {
//        packetData[i] = 0;
//    }    
}

void Brainy::clearEegPower() {
...
boolean Brainy::parsePacket(uint8_t* packetData, uint8_t packetLength) {
...
boolean Brainy::hasEEG() {
  return hasPower; // EEG power bands
}

// Keeping this around for debug use
void Brainy::printCSV() {
...
void Brainy::printPacket(uint8_t* packetData) {
    brainStream->print("[");
    for (uint8_t i = 0; i < MAX_PACKET_LENGTH; i++) {
...
uint8_t Brainy::readSignalQuality() {
    return signalQuality;
}

uint8_t Brainy::readAttention() {
    return attention;
}

uint8_t Brainy::readMeditation() {
    return meditation;
}

uint32_t* Brainy::readPowerArray() {
    return eegPower;
}

float Brainy::readDeltaFloat() {
    floatConversion_t conversion;
    
    conversion.fixedPoint = eegPower[0];
    
    return conversion.floatingPoint;
}

uint32_t Brainy::readDelta() {
    return eegPower[0];
}

uint32_t Brainy::readTheta() {
    return eegPower[1];
}

uint32_t Brainy::readLowAlpha() {
    return eegPower[2];
}

uint32_t Brainy::readHighAlpha() {
    return eegPower[3];
}

uint32_t Brainy::readLowBeta() {
    return eegPower[4];
}

uint32_t Brainy::readHighBeta() {
    return eegPower[5];
}

uint32_t Brainy::readLowGamma() {
    return eegPower[6];
}

uint32_t Brainy::readMidGamma() {
    return eegPower[7];
}
